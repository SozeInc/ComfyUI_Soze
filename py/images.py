...
class Soze_AlphaCropAndPositionImage:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "image": ("IMAGE",),
                "left_padding": ("INT", {"default": 0, "min": 0, "max": 1024}),
                "right_padding": ("INT", {"default": 0, "min": 0, "max": 1024}),
                "top_padding": ("INT", {"default": 0, "min": 0, "max": 1024}),
                "bottom_padding": ("INT", {"default": 0, "min": 0, "max": 1024}),
            }
        }
    ...
    def crop(self, image, left_padding: int = 0,right_padding: int = 0,top_padding: int = 0,bottom_padding: int = 0):
        cropped_images = []
        cropped_masks = []
